...
def _get_mock_results(query):
    return {
        "organic": [
            {
                "title": f"VP of Operations - {query} Solutions",
                "link": "https://linkedin.com/in/mock-profile-1",
                "snippet": f"Experienced VP leading {query} initiatives at TechCorp."
            },
            {
                "title": f"Director of Strategy - {query} Inc",
                "link": "https://linkedin.com/in/mock-profile-2",
                "snippet": "Driving growth and mergers in the sector."
            }
        ]
    }
